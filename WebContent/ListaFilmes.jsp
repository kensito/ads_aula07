	...
	<div class="container">
		...
		<form action="manter_filmes.do" method="POST">
			<div id="actions" class="row">
				<div class="col-md-12">
					<input type="submit" id="btnEditar" name="acao" value="Editar"
						class="btn btn-primary" disabled> <input type="submit"
						id="btnVisualizar" name="acao" value="Visualizar"
						class="btn btn-info" disabled> <input type="button"
						class="btn btn-danger" id="btnExcluir" data-toggle="modal"
						data-target="#delete-modal" value="Excluir" disabled> <a
						href="index.jsp" class="btn btn-default">Voltar</a>
				</div>
			</div>
			<br>
			<!-- modal -->
